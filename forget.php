...
<body>
    ...
    <div    class="forbox">
        ...
        <input type="text" name="forget" placeholder="Enter your mail id" /> 
        <a  href="loginn.php"  class="a1"><button class="main-btn login-btn" type="login">Forget Password</button> </a>
